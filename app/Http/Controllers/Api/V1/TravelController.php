...
class TravelController extends Controller
{
        ...
        content: new OA\JsonContent(
            properties: [
                new OA\Property(
                    ...
                    items: new OA\Items(
                        properties: [
                            ...
                            new OA\Property(property: "description", type: "string", example: "Vel vel minima sunt earum. Temporibus sint voluptas aliquam dolor aut voluptatem delectus."),
                ...
                new OA\Property(
                    property: "links",
                    properties: [
                        new OA\Property(property: "first", type: "string", example: "http://api-laravel.localhost/api/v1/travels?page=1"),
                        new OA\Property(property: "last", type: "string", example: "http://api-laravel.localhost/api/v1/travels?page=4"),
                        new OA\Property(property: "prev", type: "string", example: null, nullable: true),
                        new OA\Property(property: "next", type: "string", example: "http://api-laravel.localhost/api/v1/travels?page=2")
                    ],
                    type: "object"
                ),
                new OA\Property(
    ...
    #[OA\Get(
        path: "/api/v1/travels/{travel}",
        summary: "Travel get",
        tags: ["Travels"]
    )]
    #[OA\Parameter(
        name: "travel",
        description: "Slug travel",
        in: "path",
        required: true,
        example: "aut-totam"
    )]
        ...
        content: new OA\JsonContent(
            properties: [
                ...
                new OA\Property(
                    property: "links",
                    properties: [
                        new OA\Property(property: "first", type: "string", example: "http://api-laravel.localhost/api/v1/travels/aut-totam?page=1"),
                        new OA\Property(property: "last", type: "string", example: "http://api-laravel.localhost/api/v1/travels/aut-totam?page=4"),
                        new OA\Property(property: "prev", type: "string", example: null, nullable: true),
                        new OA\Property(property: "next", type: "string", example: "http://api-laravel.localhost/api/v1/travels/aut-totam?page=2")
                    ],
                    type: "object"
                ),
                new OA\Property(
