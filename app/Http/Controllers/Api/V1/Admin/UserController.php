        ...
        content: new OA\JsonContent(
            properties: [
                ...
                new OA\Property(
                    property: 'links',
                    properties: [
                        new OA\Property(property: 'first', type: 'string', example: 'http://travel-api.localhost/api/v1/admin/users?page=1'),
                        new OA\Property(property: 'last', type: 'string', example: 'http://travel-api.localhost/api/v1/admin/users?page=2'),
                        new OA\Property(property: 'prev', type: 'string', example: null, nullable: true),
                        new OA\Property(property: 'next', type: 'string', example: 'http://travel-api.localhost/api/v1/admin/users?page=2')
                    ],
                    type: 'object'
                ),
                new OA\Property(
                    ...
                    properties: [
                        ...
                        new OA\Property(property: 'path', type: 'string', example: 'http://travel-api.localhost/api/v1/admin/users'),
