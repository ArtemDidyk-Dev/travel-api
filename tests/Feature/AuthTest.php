...
class AuthTest extends TestCase
{
    ...
    #[Test] public function it_user_can_register(): void
    {
    ...
    #[Test] public function it_registration_fails_with_invalid_data(): void
    {
        $response = $this->postJson(route('auth.register'), [
            'name' => 'John Doe',
            'email' => 'john@doe.com',
    ...
    #[Test] public function it_user_can_login(): void
    {
        $role = Role::create(['name' => RoleEnum::USER->name]);
    ...
    #[Test] public function it_login_fails_when_user_does_not_exist(): void
    {
        $role = Role::create(['name' => RoleEnum::USER->name]);
        $user = User::factory()->create([
            'email' => 'john.doe@example.com',
